...
RUNTIME_SOURCE_PATHS = (
    ...
    ROOT / "scripts" / "readable_interpretation" / "decision_zh_tw_catalog.py",
    ...
    ROOT / "apps" / "web" / "src" / "components" / "ReaderChapter.tsx",
    ROOT / "apps" / "web" / "src" / "components" / "Phase5ReviewDashboard.tsx",
    ROOT / "apps" / "web" / "src" / "app" / "globals.css",
    ROOT / "apps" / "web" / "src" / "components" / "AstrologyResultPage.tsx",
    ROOT / "apps" / "web" / "src" / "components" / "ImmersiveCosmicDashboard.tsx",
    ROOT / "apps" / "web" / "src" / "lib" / "paid-reading" / "reader-chapter.ts",
